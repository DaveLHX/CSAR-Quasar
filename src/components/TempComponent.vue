<template>
<section>
<h6>===Start of TempComponent.vue</h6>
<q-tabs>
...
<q-datetime  type="datetime" label="Selected a time"/>
  <q-knob
  ...
  color="red"
/>
<q-btn icon="fas fa-plus-circle" color="primary" label="New item" />

  <h6>===End of TempComponent.vue</h6>
</section>
</template>
